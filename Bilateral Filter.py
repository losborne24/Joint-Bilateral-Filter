...
for image_str in args.images:
    ...
    if '.' in image_str:
        split_image_str = image_str.rsplit('.', 1)[0]
    else:
    ...
    if img is not None:
        ...
        cv2.imwrite('images/bilateral filter' + split_image_str + '_output1.png', bilateral_filter1)
        cv2.imwrite('images/bilateral filter' + split_image_str + '_output2.png', bilateral_filter1)
